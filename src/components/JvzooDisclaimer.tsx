    ...
    <section className="bg-white px-4 pb-14 pt-2 sm:px-6">
      <div className="mx-auto max-w-2xl">
        <p className="text-center text-xs leading-relaxed text-gray-400">
          ...
          Inc., a Florida corporation located at 1809 E. Broadway Street, Suite
          125, Oviedo, FL 32765, USA, and is used with permission. The role of
          JVZoo as a retailer does not constitute an endorsement, approval, or
          review of these products or any claims, statements, or opinions used
          in their promotion.
        </p>
      </div>
    </section>
